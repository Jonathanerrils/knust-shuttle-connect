/** Shuttle Connect — core Cloud Functions. */
    ...
    if (driverUid) {
      ...
      if (shuttle.exists) {
        ...
        service = {
          ...
          driverOccupancyBand:
            (data.driverOccupancyBand as string | undefined) ?? null,
          occupancyReportedAt: data.occupancyReportedAt ?? null,
          trackedOnboardCount:
            (data.trackedOnboardCount as number | undefined) ?? null,
          safeCapacity: (data.safeCapacity as number | undefined) ?? null,
        };
      }
    }
